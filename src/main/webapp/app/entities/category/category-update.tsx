  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          updatedDate: convertDateTimeFromServer(categoryEntity.updatedDate),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="monoBeFeApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField label="Create By" id="category-createBy" name="createBy" data-cy="createBy" type="text" />
              <ValidatedField
                label="Created Date"
              ...
              <ValidatedField
                label="Updated Date"
                id="category-updatedDate"
                name="updatedDate"
                data-cy="updatedDate"
                type="datetime-local"
                placeholder="YYYY-MM-DD HH:mm"
              />
              <ValidatedField label="Updated By" id="category-updatedBy" name="updatedBy" data-cy="updatedBy" type="text" />
