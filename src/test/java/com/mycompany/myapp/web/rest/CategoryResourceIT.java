...
class CategoryResourceIT {
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getCreateBy()).isEqualTo(DEFAULT_CREATE_BY);
    ...
    void putNewCategory() throws Exception {
        ...
        assertThat(testCategory.getCreateBy()).isEqualTo(UPDATED_CREATE_BY);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).updatedDate(UPDATED_UPDATED_DATE).updatedBy(UPDATED_UPDATED_BY);
